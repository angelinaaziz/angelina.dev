...
For most of that time, I was living on autopilot. Default mode. Taking the easy option, every single time. Order takeout instead of cooking. Skip the walk. Scroll instead of read. Ignore the problem instead of addressing it.
